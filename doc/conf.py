...
jinja_contexts = {
    'version_uris': {
        'examples_uri': f'https://github.com/laudrup/async-ssh/tree/v{version_from_cmdline}/examples',
    }
}

breathe_default_project = 'async_ssh'
